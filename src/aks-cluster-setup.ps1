...
$AKS_NAME="<Enter Azure Kubernets Cluster Name>"                     # Azure Kubernetes Service Name
...
$IDENTITY_NAME="<Enter Azure Identity Mangement Name>"               # Managed Identity Name
$AKS_NODE_COUNT = "<Enter integer value>"                            # Number of Nodes in AKS eg: 2
$LOCATION = "<Enter Azure Region Name "                              # Region Name eg: East US 2
$ZOOKEEPER_BLOB_STORAGE = "<Enter Storage Capacity Value in Gi>"     # Zookeeper BlobFuse Storage Capacity eg: 100Gi
$KAFKA_BLOB_STORAGE = "<Enter Storage Capacity Value in Gi>"         # Kakfa BlobFuse Storage Capacity eg: 500Gi
$ZOOKEEPER_DISK_STORAGE = "<Enter Storage Capacity Value in Gi>"     # Zookeeper Disk Storage Capacity eg: 25Gi
$KAFKA_DISK_STORAGE = "<Enter Storage Capacity Value in Gi>"         # Kakfa Disk Storage Capacity eg: 50Gi
$ENVIRONMENT = "test"                                                # Enrionment Name
$HUMIO_AUTHENTICATION_METHOD ="single-user"                          # Authentication Method to get into Logscale
$HUMIO_PASSWORD = "<Enter the desired Password>"                     # Logscale Password
$HUMIO_CLUSTER_NAME ="example-humiocluster"                          # Logscale Cluster Name
$HUMIO_CLUSTER_REPLICATION = "<Enter integer value>"                 # Logscale Replication Factor eg: 3
$HUMIO_NODE_COUNT = "<Enter integer value>"                          # LogScale Node Count eg: 2
$HUMIO_STORAGE_CAPACITY = "<Enter Storage Capacity Value in Gi>"     # LogScale Internal Storage Capacity eg: 10Gi
...
$KAFKA_ZOOKEEPER_REPLICATION = "<Enter integer value>"               # Zookeeper Kafka Replication Factor eg: 3
$KAFKA_CLUSTER_NAME = "<Enter KAFKA Cluster Name>"                   # KAFKA Cluster Name
$HUMIO_OPERATOR_VERSION = "<Enter the Humio Operator Ver>"           # Humio Operator Version eg: 0.19.0
$AKS_VM_MACHINE = "<Enter AKS VM Size SKU Name>"                     # AKS VM Machine Size eg: Standard_DS2_v2
$AKS_VERSION = "<Enter AKS Version>"                                 # AKS Version eg: 1.25.6
...
$LOG_LEVEL = "<Enter log level>"                                     # Log Level (debug,info,warning,error,critical)
$KAKFA_COUNTER_LIMIT = "<Enter integer value>"                       # Kafka Counter to check the status Kafka Running Pods eg: 15
$VNET_NAME = "<Enter Vnet name for AKS & App Gateway>"               # Vnet name for AKS and App Gateway
$VNET_CIDR = "<Enter Vnet CIDR>"                                     # Vnet CIDR eg: 10.224.0.0/12
$AKS_SUBNET ="<Enter Aks subnet name>"                               # Aks subnet name
$AKS_SUBNET_CIDR = "<Enter Aks subnet CIDR"                          # Aks subnet CIDR eg: 10.224.0.0/16
$APP_GATEWAY ="<Enter App gateway Name for ingress>"                 # App gateway for ingress
$APP_GATEWAY_SUBNET ="<Enter Subnet Name for App Gateway>"           # Subnet for App Gateway
$APP_GATEWAY_SUBNET_CIDR = "<Enter Subnet CIDR For App Gateway>"     # Subnet CIDR For App Gateway eg: 10.225.1.0/24
$PUBLIC_IP = "<Enter Public Ip Name for Ingress>"                    # Public Ip for Ingress
